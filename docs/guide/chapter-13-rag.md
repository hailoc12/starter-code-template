...
Về các con số "cải thiện từ 60% lên 87%" khi thêm kỹ thuật X mà không có benchmark nguồn: **coi là số minh họa — hãy đo lại bằng RAGAS trên data của bạn.** Chương [Kiểm thử và Đánh giá](chapter-08.md) (mục 10.6) hướng dẫn đầy đủ cài đặt RAGAS, golden dataset, LLM-judge khác generator, và cách trình bày eval evidence cho Demo Day — chương này chỉ đặt câu hỏi "đo gì"; chương 10 trả lời "đo thế nào".
...
Chương liên quan: [Kiểm thử và Đánh giá](chapter-08.md) cho RAGAS chi tiết và eval evidence; chương kiến trúc agent cho LangGraph; mục anti-patterns cho các lỗi RAG phổ biến đã ghi nhận qua các cohort.
