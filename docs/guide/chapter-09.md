...
**10. Evaluation Evidence:** Bằng chứng đánh giá chất lượng agent — golden dataset, metrics, benchmark, feedback người dùng. Xem [Chương 10](chapter-08.md) mục 10.5 và 8.6. Với 82% đội cohort trước thiếu deliverable này, đây là cơ hội ghi điểm lớn nhất tính theo effort.
...
|--------------|--------------------|
| Liệt kê 10-15 edge case và mỗi edge case có test tương ứng trong repo (xem [Chương 7](chapter-12-workflow.md)) | Thư mục `tests/` với test đặt tên theo edge case |
...
| Có RAG thì đo được chất lượng retrieval + generation (RAGAS, xem [Chương 10](chapter-08.md) mục 10.6) | Bảng RAGAS metrics trong `docs/evaluation.md` |
...
Đây là tiêu chí mà 82% đội cohort trước không có bằng chứng — playbook chi tiết đầy đủ nhất nằm ở [Chương 10](chapter-08.md) mục 10.5 (bao gồm cả bảng "lên Giỏi" riêng cho tiêu chí này).
...
| Route `/privacy` thật (không link chết `#`) nếu sản phẩm chạm dữ liệu cá nhân — checklist privacy-by-domain ở [Chương Privacy](chapter-14-privacy.md) | Link privacy hoạt động + mô tả xử lý dữ liệu |
...
| USP khai báo rõ và chạy được end-to-end từ UI công khai đến output (xem [Chương 5](chapter-11-usp.md)) | Demo USP ngay trong video demo |
...
82% đội cohort trước không có bằng chứng đánh giá hiệu quả. Đây là deliverable bị bỏ qua nhiều nhất nhưng là cơ hội ghi điểm lớn nhất — làm theo [Chương 10](chapter-08.md) mục 10.5, xong trong 1-2 ngày.
