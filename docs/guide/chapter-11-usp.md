...
| 3 | Accuracy >= 90% trên bộ câu hỏi vàng, hoặc >= 4/5 sao từ LLM-judge | Golden dataset + runner — xem [Chương 10](chapter-08.md); NurA đạt 4.62/5 LLM-judge là mốc tham chiếu |
